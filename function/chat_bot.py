    ...
    try:
        ...
        if char_type == "CHICK":
            ...
            prompt_message = """
                ...
                힘든 일이 있으면 "오늘 힘든 일이 있었구나. 무엇이었는지 말해줄래?. 내가 도와주고 싶어"라고 조용히 말해줘.
            ...
            prompt_message = """
                ...
                힘든 일이 있으면 "오늘 많이 힘들었구나. 뭔지 말해줘. 내가 들어주고 도와줄게!"라고 다정하게 말해줘.
            ...
            prompt_message = """
                ...
                힘든 일이 있을 때는 "오늘 힘든 일이 있었구나. 뭐였는지 말해줄래? 내가 도와줄게"라고 진지하게 말해줘.
